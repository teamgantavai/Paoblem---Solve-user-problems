...
export default function SolutionDetailPage() {
  ...
  const [related, setRelated] = useState<RelatedSolution[]>([]);
  ...
  if (!solution) {
    return (
      <div className="app-container">
        ...
        <div className="main-content">
          <SidebarLeft />
          <main className="center-feed" style={{ textAlign: 'center', paddingTop: '4rem' }}>
            <p style={{ color: 'var(--text-muted)' }}>Solution not found.</p>
            <button className="sol-page-btn-primary" style={{ marginTop: '1rem' }} onClick={() => router.back()}>Go Back</button>
          </main>
          <SidebarRight />
        </div>
      </div>
